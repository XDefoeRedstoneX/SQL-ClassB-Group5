...
INSERT INTO Customers (Customer_ID, Customer_Name, Cust_Email, Cust_Password, Cust_Number, status_del) VALUES ('BUD01', 'Budi Santoso', 'budi@mail.com', MD5('pass123'), '08123456789', 0),
...
INSERT INTO Batches (Batch_ID, Batch_Name, Open_Date, Close_Date, Delivery_Date, Status, status_del) VALUES 
	('B112501', 'Batch November', '2025-11-01 08:00:00', '2025-11-30 22:00:00', '2025-11-27', 0, 0);
...
INSERT INTO Orders (Orders_ID, Customer_ID, Batch_ID, Date_In, Order_Status, Order_For_Date, status_del) VALUES 
	('O12112501', 'BUD01', 'B112501', '2025-11-12', 2, '2025-11-12', 0);

INSERT INTO Orders (Orders_ID, Customer_ID, Batch_ID, Date_In, Order_Status, Order_For_Date, status_del) VALUES 
	('O18112501', 'DIM01', 'B112501', '2025-11-18', 2, '2025-11-18', 0);

INSERT INTO Orders (Orders_ID, Customer_ID, Batch_ID, Date_In, Order_Status, Order_For_Date, status_del) VALUES 
	('O24112501', 'ASE01', 'B112501', '2025-11-24', 0, '2025-11-24', 0);

INSERT INTO Orders (Orders_ID, Customer_ID, Batch_ID, Date_In, Order_Status, Order_For_Date, status_del) VALUES 
	('O26112501', 'SIT01', 'B112501', '2025-11-26', 1, '2025-11-26', 0);

INSERT INTO Order_List (Product_ID, Orders_ID, Quantity, Order_Date) VALUES
	('P0002', 'O26112501', 2, '2025-11-26'),
	('P0003', 'O26112501', 1, '2025-11-26');
...
INSERT INTO Sales (Sales_ID, Orders_ID, Date_Completed, Payment, status_del) VALUES
	('S24112501', 'O24112501', '2025-11-24', 'Cash', 0);

INSERT INTO Sales_List (Product_ID, Sales_ID, Quantity, Total_Price) VALUES
	('P0004', 'S24112501', 1, 35000.00),
	('P0001', 'S24112501', 2, 50000.00);

INSERT INTO Waste (Waste_ID, Production_ID, Product_ID, Quantity, Price, status_del) VALUES 
	('W01112501', 'PR01112503', 'P0003', 1, 5000.00, 0);

INSERT INTO Waste (Waste_ID, Production_ID, Product_ID, Quantity, Price, status_del) VALUES
	('W02112501', 'PR01112502', 'P0002', 2, 24000.00, 0);
...
INSERT INTO Feedback (Feedback_ID, Sales_ID, Customer_ID, Feedback_comment, Rating, status_del) VALUES
	('FASE01', 'S24112501', 'ASE01', 'The food arrived late and was cold.', 2, 0);
