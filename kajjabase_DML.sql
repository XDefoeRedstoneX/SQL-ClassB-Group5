...
INSERT INTO Customers (Customer_ID, Customer_Name, Cust_Email, Cust_Password, Cust_Number, status_del) VALUES
                                                                                                           ('BUD01', 'Budi Santoso', 'budi@mail.com', 'MD5HASH123', '08123456789', 0),
                                                                                                           ('DIM01', 'Dimas Pratama', 'dimas@mail.com', 'MD5HASH123', '08198765432', 0),
                                                                                                           ('ASE01', 'Asep Surasep', 'asep@mail.com', 'MD5HASH123', '08134567890', 0),
                                                                                                           ('SIT01', 'Siti Aminah', 'siti@mail.com', 'MD5HASH123', '08145678901', 0),
                                                                                                           ('JOK01', 'Joko Anwar', 'joko@mail.com', 'MD5HASH123', '08156789012', 0);
...
INSERT INTO Order_List (Product_ID, Orders_ID, Quantity, Order_Date) VALUES
                                                                         ('P0002', 'O18112501', 1, '2025-11-18'), -- Large Chicky
                                                                         ('P0003', 'O18112501', 1, '2025-11-18'); -- Small Minion

INSERT INTO Orders (Orders_ID, Customer_ID, Date_In, Order_Status, Order_For_Date, status_del) VALUES
    ('O24112501', 'ASE01', '2025-11-24', 0, '2025-11-24', 0);

INSERT INTO Order_List (Product_ID, Orders_ID, Quantity, Order_Date) VALUES
                                                                         ('P0004', 'O24112501', 1, '2025-11-24'), -- Large Minion
                                                                         ('P0001', 'O24112501', 2, '2025-11-24'); -- 2x Small Chicky
...
INSERT INTO Waste (Waste_ID, Production_ID, Quantity, Price, status_del) VALUES
    ('W01112501', 'PR01112503', 1, 25000.00, 0);

INSERT INTO Feedback (Feedback_ID, Sales_ID, Customer_ID, Feedback_comment, Rating, status_del) VALUES
    ('FBUD01', 'S12112501', 'BUD01', 'kecil tp enak👍.', 4, 0);